<div class="footer">
    <div id="chatKH"> chatfacebook
      ...
      <script>(function(d, s, id) {
          ...
          js.src = 'https://connect.facebook.net/vi_VN/sdk.js#xfbml=1&autoLogAppEvents=1&version=v3.0&appId=208382249845915';
          fjs.parentNode.insertBefore(js, fjs);
      }(document, 'script', 'facebook-jssdk'));</script>

      <?php if($settings['Setting']['setting_messenger']==1): ?>
