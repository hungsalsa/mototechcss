<div class="content-page">
    <h1 class="title"><?= $category['BlogCategory']['name'] ?></h1>
    <div class="row">
                    ...
                    <div class="media news">
                        <div class="media-body">
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    <div class="main_news">
                                        <h2><a href="<?= $this->Html->url(array('action' => 'postIndex', 'slug' => $item['Post']['slug'])); ?>"><?= $item['Post']['name'] ?></a></h2>
                                        <div class="desription_news"><?= $this->Text->truncate(strip_tags($item['Post']['content']), 360) ?></div>
                                    </div>
                                </div>
                            </div>
