...
<div class="menu-top">
    <div class="container">
        <div class="row list-inline">
            <div class="col-md-3 col-sm-3"><a href="<?= Router::url('/p/cac-dia-chi-he-thong-mototech'); ?>">Địa chỉ Mototech</a></div>
            <div class="col-md-3 col-sm-3"><a href="<?= Router::url('/p/quy-trinh-dich-vu-bao-duong-va-sua-chua-xe-may'); ?>">Quy trình bảo dưỡng</a> </div>
            <div class="col-md-3 col-sm-3">Giải đáp <span>kỹ thuật</span> : <strong><?php echo $settings['Company']['phone'] ?></strong></div>
            <div class="col-md-3 col-sm-3">Cứu hộ <span>khẩn cấp</span> : <strong><?php echo $settings['Company']['phone_sos'] ?></strong></div>
        </div>
...
<div class="row" style="position: relative; z-index: 9">
    ...
    <div class="col-md-3">
        <div class="block-white free_block_white">
...
<div class="row">
    ...
    <div class="col-md-3" id="sidebar">
        ...
        <div class="fb-page pagefacebook" data-href="https://www.facebook.com/suachuaxemaymototech" data-tabs="timeline" data-width="" data-height="270" data-small-header="false" data-adapt-container-width="true" data-hide-cover="false" data-show-facepile="true"><blockquote cite="https://www.facebook.com/suachuaxemaymototech" class="fb-xfbml-parse-ignore"><a rel="nofollow" href="https://www.facebook.com/suachuaxemaymototech">Hỗ trợ Mototech</a></blockquote></div>      
        <?php
        foreach ($introductions as $item):
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-9">
                ...
                ?>
                <a href="#" class="label label-danger email"><?php echo $settings['Company']['phone_sos'] ?></a>
            </div>
        </div><!-- social -->
    </div>
</div>
